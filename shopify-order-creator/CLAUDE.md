...
## Current mission (TAA-13 parity signed off 2026-07-22 → now TAA-3 baseline lives in TS)
...
8. NS cases 7–8: **on hold, deferred pending JJ's review post-rewrite** — read-back endpoint is confirmed (see above) for whenever that review happens, but don't build `clients/newstore.ts`/reader/verify/case wiring without sign-off first.
